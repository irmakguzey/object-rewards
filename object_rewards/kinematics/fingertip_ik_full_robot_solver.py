        ...
        for i, finger_type in enumerate(["index", "middle", "ring", "thumb"]):
            if finger_type in self.fingertip_link_mappings.keys():
                ...
                if (
                    ...
                    ).all(), f"Arm endeff poses are different for fingers {first_finger_type}({first_arm_joints}) and {finger_type}({next_arm_joints})"
        ...
        for i, finger_type in enumerate(["index", "middle", "ring", "thumb"]):
            if finger_type in self.fingertip_link_mappings.keys():
                ...
                if (
                    ...
                    ).all(), f"Arm {link_name} poses are different for fingers {first_finger_type}({first_arm_joints}) and {finger_type}({next_arm_joints})"
