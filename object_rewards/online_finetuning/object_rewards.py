...
class ObjectRewarder:
    def __init__(
        ...
        **kwargs,
        ...
        self.image_transform = T.Compose(
            [T.Resize((480, 640)), T.Lambda(lambda image: crop_transform(image, camera_view=view_num))]
        )
    ...
    def _get_tracks(self, frames, prompt, visualize=False, is_human=True, episode_id=0):
        ...
        frame_matches = self.expert_frame_matches if is_human else self.episode_frame_matches
        if frame_matches != -1:
