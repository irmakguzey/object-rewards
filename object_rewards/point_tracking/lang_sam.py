...
# This is copied from: https://github.com/luca-medeiros/lang-segment-anything
...
class LangSAM:
    ...
    def __init__(
        ...
        print(f"IN LANGSAM - self.device: {self.device}")
    ...
    def predict_dino(
        self, image_pil, text_prompt, box_threshold, text_threshold
    ):  # If as_batch, image_pil will be a list of images
    ...
    def predict_sam(self, image_pil, boxes):
        ...
        masks, _, _, embeddings = self.sam.predict_torch(
            point_coords=None,
            point_labels=None,
    ...
    def predict(self, image_pil, text_prompt, box_threshold=0.3, text_threshold=0.25):
        ...
        embeddings = torch.randn(1, 256, 64, 64)
        if len(boxes) > 0:
